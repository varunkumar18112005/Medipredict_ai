          ...
          >
            {item.image ? (
              ...
              <div className="depth-carousel__card-body">
                {item.icon && (
                  <div className="depth-carousel__card-icon-wrapper">
                    {typeof item.icon === 'string' ? item.icon : item.icon}
                  </div>
                )}
                {item.title && <h3 className="depth-carousel__card-title">{item.title}</h3>}
                {item.desc && <p className="depth-carousel__card-desc">{item.desc}</p>}
              </div>
            )}
            <span
